...
(function (Blumenwiese_L09) {
    class Flower {
        constructor(_position, _scaleFactor, _color) {
        ...
        draw() {
            let gradientFlower = Blumenwiese_L09.crc2.createRadialGradient(0, -118, 8, 0, -118, 50);
            ...
            Blumenwiese_L09.crc2.strokeStyle = "#8ddb56";
            Blumenwiese_L09.crc2.fillStyle = "#8ddb56";
            Blumenwiese_L09.crc2.fill(stem);
            Blumenwiese_L09.crc2.stroke(stem);
            Blumenwiese_L09.crc2.restore();
            //blossom
            Blumenwiese_L09.crc2.save();
            Blumenwiese_L09.crc2.translate(randomX, this.position.y);
            Blumenwiese_L09.crc2.scale(this.scaleFactor, this.scaleFactor);
            Blumenwiese_L09.crc2.fillStyle = gradientFlower;
            Blumenwiese_L09.crc2.fill(blossom);
            Blumenwiese_L09.crc2.restore();
        }
    }
    Blumenwiese_L09.Flower = Flower;
